...
It could be if it is the case that the movie profits are normally distributed. But in our calculation the data is highly skewed and has an extreme outlier leading to a less reliable estimate.
...
We are 99% confident that the true mean runtime of all thriller movies in the population falls between 99.9 and 111.0 minutes. 
...
We are 99% confident that the true mean runtime of thriller movies in the entire population falls between 100.1 and 110.8 minutes. 
...
In the scatterplot you can see that movies with a longer run time
# Week 4 
