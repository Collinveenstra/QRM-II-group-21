...
As a result, when calculating the average logarithm of profits, films with zero or negative profits are excluded from the calculation, as their logarithm values are undefined. The average then only reflects films with positive profits, which distorts the result because loss-making or break-even films are not taken into account.
...
The average lies around the 100 minutes, movies with a longer runtome are considered better.
