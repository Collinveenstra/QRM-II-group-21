...
-1,76x10^7 + 3,547xBudget. If a movie had a budget of 0, expected profits would be about -17,6 million euros. For every 1 euro increase in budget, expected profits rise by 3,55 euro on average.
...
Month of release matters. It is better to release the movie in month 6 or 12, because those generated the most profit. Month 1 and 9 generated the least profit, so the movie should release in those months.
...
An increase of 1% in budget, increases the revenue with 0.75%.
English films have an estimated 35% lower revenue than not English films.
...
```{r}
#WRITE YOUR CODE HERE
model<- lm(log_revenue~log_budget)
```
